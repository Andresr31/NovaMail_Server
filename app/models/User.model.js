...
// Cargamos el módulo de bcryp
// Hash de contraseña
const bcrypt = require('bcrypt');
/*
Definimos el factor de costo, el cual controla cuánto tiempo se necesita para calcular un solo hash de BCrypt. 
Cuanto mayor sea el factor de costo, más rondas de hash se realizan. 
Cuanto más tiempo sea necesario, más difícil será romper el hash con fuerza bruta.
*/
const saltRounds = 10;
